 ...
 */
@Slf4j
public class BatProperties {
    public final static String CONFIG_FILE = "config/bat.properties";
    ...
    public BatProperties(File file, String encoding) {
    ...
    public BatProperties(String fileName, String encoding) {
        this.properties = null;
